...
nmap <silent> ,k :NERDTree
nmap <silent> ,v :vsp $MYVIMRC
...
nnoremap <silent> <F8> :make run
nnoremap <silent> <F7> :make build
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set background=dark
...
silent only
cd /cygdrive/d/Programms/Rust/manga_db
