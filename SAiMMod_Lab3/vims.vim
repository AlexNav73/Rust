...
silent only
cd /cygdrive/d/Programms/Rust/SAiMMod_Lab3
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 src/main.rs
badd +7 src/modules/mod.rs
badd +1 source.rs
badd +31 src/modules/source.rs
badd +1 test.rs
badd +22 src/modules/consumer.rs
badd +40 src/modules/channel.rs
argglobal
silent! argdel *
argadd src/main.rs
edit src/main.rs
...
exe 'vert 1resize ' . ((&columns * 90 + 95) / 191)
exe '2resize ' . ((&lines * 22 + 24) / 49)
exe 'vert 2resize ' . ((&columns * 90 + 95) / 191)
exe '3resize ' . ((&lines * 30 + 24) / 49)
exe 'vert 3resize ' . ((&columns * 100 + 95) / 191)
exe '4resize ' . ((&lines * 15 + 24) / 49)
exe 'vert 4resize ' . ((&columns * 100 + 95) / 191)
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 17 - ((13 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
...
exe '4resize ' . ((&lines * 15 + 24) / 49)
exe 'vert 4resize ' . ((&columns * 100 + 95) / 191)
tabedit src/modules/channel.rs
set splitbelow splitright
set nosplitbelow
wincmd t
set winheight=1 winwidth=1
