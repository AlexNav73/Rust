...
silent only
cd /cygdrive/d/Programms/Rust/COS_Lab3
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 src/main.rs
badd +12 src/rsignal/signal.rs
badd +8 src/rsignal/lib.rs
badd +1 src/rsignal/graph.rs
badd +1 chart.rs
badd +32 src/rsignal/chart.rs
badd +1 Cargo.toml
badd +3 src/rsignal/abi.rs
argglobal
silent! argdel *
argadd src/main.rs
edit src/rsignal/chart.rs
...
27
normal! zo
let s:l = 51 - ((33 * winheight(0) + 23) / 46)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((9 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
