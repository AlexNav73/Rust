...
//fn main() {
//
//    let socket = match UdpSocket::bind("127.0.0.1:35666") {
//        Ok(s) => s,
//        Err(e) => panic!("Bind error with message: {}", e),
//    };
//
...
//    let port = 35666;
//    let res = match socket.send_to(&[1, 2, 3, 4, 5], (addr, port)) {
//        Ok(send) => send,
//        Err(e) => panic!("Send error with message: {}", e),
//    };
//    println!("Send {} bytes.", res);
//
//    drop(socket);
//    
//}
